...
MAIN:
	...
	clr R17	; r17 = 0
LOOP:
	; call subroutine to get char
	rcall IN_CHAR
	ADD R17, R16	; add value to R17+=R1622
	MOV R16, R17	; R16 = R17
	rcall OUT_CHAR	; call subroutine to output accumulator value
...
INIT_USART:
	...
	ldi R16, 0x33
	sts USARTD0_CTRLC, R16		;Set odd Parity, 8 bit frame, 1 stop bit
