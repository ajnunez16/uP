/*
lab 7, 4. VISUALIZING THE ADC CONVERSIONS
Name: Alexander Nunez
Class #: 11697
PI Name: Chris Crary
Description:   This program will visually display the CdS cell’s voltage using SerialPlot.
 This will behave like a very basic oscilloscope. 
 */ 
